    ...
    <div>
      ...
      <Disclosure>
        <div className="flex flex-row justify-between bg-gray-100 w-full rounded mobile:px-2 py-2">
          <div>jksdhfus</div>
          <div>
            <Disclosure.Button>angka</Disclosure.Button>
          </div>
        </div>
        <Transition
            ...
            <div className="flex flex-col">
              ...
              <div className="text-gray-500">
                ...
                <p className=" text-justify py-2">
                  ...
                  Temporibus corrupti voluptatum vel molestias beatae mollitia
                  totam deserunt laborum? Saepe nihil soluta pariatur aperiam
                  tenetur laboriosam, repellat itaque enim ea magnam hic
                  temporibus optio praesentium omnis quam magni architecto illum
                  nesciunt, rerum est error a corporis suscipit! Quos quasi
                  incidunt quod.
                </p>
              </div>
              <div>
